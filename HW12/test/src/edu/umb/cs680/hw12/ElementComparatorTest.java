...
class ElementComparatorTest {
    ...
    ApfsLink y = new ApfsLink(code, "y", 0, localTime,"ApfsFile1",localTime,b);
    ApfsLink z = new ApfsLink(code, "z", 0, localTime,"ApfsFile2",localTime,b);
    @Test
    ...
    public void GetFileTestCode() {
        ...
        LinkedList<ApfsLink> actual = dir.getLinks(new ElementComparator());
        ApfsLink[] expected = { y, z };
        assertArrayEquals(expected, actual.toArray());
    }
    @Test
    public void GetFileTestCode2() {
        ApfsDirectory dir = code;
