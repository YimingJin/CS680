...
public class ElementComparatorTest {
    ...
    public void getChildrenCodeTest() {
        ...
        LinkedList<ApfsElement> actual = dir.getChildren((ApfsElement obj1, ApfsElement obj2) -> obj1.getOwnerName().compareTo(obj2.getOwnerName()));
    ...
    public void getSubDirectoryRootTest() {
        ...
        LinkedList<ApfsDirectory> actual = dir.getSubDirectories((ApfsElement obj1, ApfsElement obj2) -> obj1.getOwnerName().compareTo(obj2.getOwnerName()));
    ...
    public void getFilesHomeTest() {
        ...
        LinkedList<ApfsFile> actual = dir.getFiles((ApfsElement obj1, ApfsElement obj2) -> obj1.getOwnerName().compareTo(obj2.getOwnerName()));
